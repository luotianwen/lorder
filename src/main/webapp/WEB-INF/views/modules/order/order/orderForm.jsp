...
<form:form id="inputForm" modelAttribute="order"   method="post" class="form-horizontal">
	...
	<div class="row control-group">
		...
		<div class="span3 ">
			<form:input path="taskNo" htmlEscape="false" maxlength="50" class="input-xlarge required" readonly="true"/>
		</div>
		...
		<div class="span2 ">
			<input name="taskGenDatetime" type="text" readonly="true" maxlength="20" class="input-medium Wdate required"
		...
		<div class="span2 ">
			<form:select path="taskStatus" class="input-medium required" disabled="true">
				<form:option value="" label=""/>
	...
	<div class="row control-group">
		...
		<div class="span2 ">
			<form:input path="taskAmount" htmlEscape="false" class="input-medium required number" readonly="true"/>
		</div>
		...
		<div class="span2 ">
			<form:input path="socre" htmlEscape="false" maxlength="2" class="input-medium " readonly="true"/>
		</div>
	</div>
	<div class="row control-group">
		...
		<div class="span2 ">
			...
			<form:select path="saleGroup" class="input-medium required" disabled="true">
				<form:option value="" label=""/>
		...
		<div class="span2 ">
			<form:select path="taskType" class="input-medium required" disabled="true">
				<form:option value="" label=""/>
	...
	<div class="row control-group">
		...
		<div class="span2 ">
			<form:input path="addressDetail" htmlEscape="false" maxlength="512" class="input-medium required"  readonly="true"/>
		</div>
			<%--	</div>--%>
			<%--<div class="row control-group">
	...
	<div class="row control-group"><label class="span1 control-label">收货人名称：</label>
		...
		<div class="span2 ">
			<form:input path="carriers" htmlEscape="false" maxlength="50" class="input-medium " readonly="true"/>
		</div>
